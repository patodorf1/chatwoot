...
const linkedinUrl = computed(() => {
  const customAttrs = props.selectedContact?.customAttributes || props.selectedContact?.custom_attributes || {};
  return customAttrs.linkedin_url || customAttrs.linkedinUrl || '';
});
